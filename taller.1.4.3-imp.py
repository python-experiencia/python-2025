...
estado = int(input(('ingresa el numero que representa tu estado civil: ')))

nombre = input('ingresa tu nombre y apellidos: ')

monto = float(input('ingresa el monto de ingresos anuales en dolares : $ '))


match  estado : # condiciono estado segun el valor del monto
    case 1 if monto < 20000:
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 10%')
        print(f'el valor del impuesto a pagar es =', monto * 0.1, 'dolares')
    case 1 if 20000 > monto < 50000 :
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 15%')
        print(f'el valor del impuesto a pagar es =', monto * 0.15, 'dolares')
    case 1 if 50000 > monto :
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 20%')
        print(f'el valor del impuesto a pagar es =', monto * 0.2, ' dolares')
    case 2 if monto < 30000:
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 8%')
        print(f'el valor del impuesto a pagar es =', monto * 0.08, 'dolares')
    case 2 if 30000 > monto < 60000 :
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 12%')
        print(f'el valor del impuesto a pagar es =', monto * 0.12, 'dolares')
    case 2 if 60000 > monto :
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 18%')
        print(f'el valor del impuesto a pagar es =', monto * 0.18, 'dolares')
    case 3 if monto < 25000:
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 9%')
        print(f'el valor del impuesto a pagar es =', monto * 0.09, 'dolares')
    case 3 if 25000 > monto < 55000 :
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 14%')
        print(f'el valor del impuesto a pagar es =', monto * 0.14, 'dolares')
    case 3 if 55000 > monto :
        print(f'hola ', nombre, 'su ingreso anual es de ', monto)
        print('el valor del impuesto es del 19%')
        print(f'el valor del impuesto a pagar es =', monto * 0.19, 'dolares')
    case _ :
